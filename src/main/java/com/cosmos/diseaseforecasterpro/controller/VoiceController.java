...
public class VoiceController {
    ...
    public ResponseEntity<Resource> processVoice(HttpServletRequest req, @RequestParam(value = "text") String text) {
        try {
            // 调用服务生成音频文件
            File outputFile = voiceToVoiceService.processVoice(req, text);
